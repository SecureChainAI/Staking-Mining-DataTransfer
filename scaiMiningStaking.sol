...
contract scaiMiningStaking is Ownable,  ReentrancyGuard {
    ...
    function EditStake(uint256 inx, address _user, uint256 amt,LockingPeriod lockduration,uint256 interestrate, uint256 starttime,uint256 endtime) external onlyOwner
    {   
        ...
        stakedata.interestRate = interestrate;
